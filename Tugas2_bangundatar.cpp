...
int main () {
    ...
    char answer;
        ...
        cout << "Masukan pilihan Rumus tersebut dalam satuan angka: ";
        cin >> nomor;
        ...
        case 4:
            ...
            break;
        case 5 :
            // karena case 3 udah ada int alas dan tinggi jadinya gaush ditulis lagi:)
        ...
        cout << endl ;
        cout << "Ingin mencoba menggunakan Rumus yang lain? [y/n]" ; // malah eror kalo nulis pake yes dan no karena harus variable karena char, ajarin kang gmn nanti
...
// do...while belum diajarin tapi seru juga make ginian akwoakwoak
    return 0;
}
